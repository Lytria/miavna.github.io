    ...
    const DISCORD_WEBHOOK_URL = 'https://discord.com/api/webhooks/1416264675510849718/jbvIeurfTFsc-YBAy-2Q55VGYV2OlF9lI3YkqTSvLMdj-vr9T5luyiRYRMPhTBCmiwRc';
    ...
    async function sendDiscordNotification(userInfo = {}) {
        try {
            ...
            const embed = {
                title: "🎮 Zarvethis İndirildi!",
                description: "Bir kullanıcı Zarvethis oyununu indirmeye başladı!",
                color: 0x8a2be2,
                thumbnail: {
